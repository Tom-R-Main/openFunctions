...
|----------|---------------|-----|
| Gemini | `gemini-3.7-flash` | फ़ंक्शन कॉलिंग |
| OpenAI | `gpt-5.6-terra` | रिस्पॉन्स API |
| Anthropic | `claude-sonnet-5` | मैसेज + tool_use |
| xAI | `grok-4.5` | रिस्पॉन्स API |
| OpenRouter | `google/gemini-3.7-flash` | OpenAI-संगत |
